...
#SPECTPATH = '/home/sidrah/DL/ukybirddet/workingfiles/spect/'
LABELPATH = 'labels/'
FILELIST = 'workingfiles/filelists/'

RESULTPATH = 'trained_model/adaptation/'
SUBMISSIONFILE = 'DCASE_submission_adaptation.csv'
